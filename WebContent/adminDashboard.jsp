...
<body>
	...
	<div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <br />
                    <form action="StartStop" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Web Project Name</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" id="webProjectName" name="webProjectName" placeholder="Project Name" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Project Description</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" id="webProjectDesc" name="webProjectDesc" placeholder="Project Description" required>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Web Technology</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id="webTech" name="webTech" class="form-control" >
                            <option value="mysql">Java War</option>
                            <option value="mongodb">NODE App</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Number of Instances</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id="noOfInstances" name="noOfInstances" class="form-control" >
                      ...
                      <div class="form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Web Project Artifact Upload</label>
                         <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success">Create Web VM(s)</button>
                        </div>
                      </div>
